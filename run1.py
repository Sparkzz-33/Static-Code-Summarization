...
#LSTM 1 
encoder_lstm1 = LSTM(latent_dim, dropout = 0.4, recurrent_dropout = 0.4, return_sequences=True,return_state=True) 
encoder_output1, state_h1, state_c1 = encoder_lstm1(enc_emb) 

#LSTM 2 
encoder_lstm2 = LSTM(latent_dim, dropout = 0.4, recurrent_dropout = 0.4, return_sequences=True,return_state=True) 
encoder_output2, state_h2, state_c2 = encoder_lstm2(encoder_output1) 

#LSTM 3 
encoder_lstm3=LSTM(latent_dim, dropout=0.4, recurrent_dropout=0.4, return_state=True, return_sequences=True) 
